...
export const ColumnItem = ({mangaTracked, updateMangas}) => {
            ...
            <div className="row p-2 text-left">
                <div className="col-auto">
                    <Link to={"/mangas/" + mangaTracked.id}>
                        <img src={manga.imgSrc} className="img-column-item shadow" alt="Manga cover"/>
                    </Link>
                </div>
                <div className="col pl-0">
                    <p className="text-dark font-weight-bold mb-0">{getReducedText(manga.title, 15)}</p>
